...
* Require exact release identity and zero-finding Plugin Check fingerprint evidence.
* Accept immutable content-addressed package URLs on the Devenia download channel.
